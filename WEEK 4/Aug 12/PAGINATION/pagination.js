...
head.innertext="PAGINATION TASK"
...
document.getElementById("our-table").appendChild(b); 
  
var c = document.createElement("TH");
c.setAttribute("class", "text-center");
var d = document.createTextNode("ID"); 
c.appendChild(d); 
...
var h = document.createTextNode("EMAIL"); 
g.appendChild(h); 
document.getElementById("MyTr").appendChild(g); 

var m = document.createElement("TBODY");
m.setAttribute("id", "table-body");

document.getElementById("our-table").appendChild(m);

var page1 = document.createElement('div')
page1.setAttribute('class', 'container')

var pagebutton = document.createElement('div')
pagebutton.setAttribute('id', 'pagination-wrapper')

page1.appendChild(pagebutton)
...
// To create Table Rows & append to table
function buildTable() {
    ...
    for (var i = 1 in myList) {
        // Template Litterals to create rows
        var row = `<tr >
                  <td class="text-center">${myList[i].id}</td>
                  <td class="text-left">${myList[i].name}</td>
                  <td class="text-left">${myList[i].email}</td>
                  `
        table.append(row)
    }
